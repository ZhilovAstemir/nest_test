const translationsRu = {
  messages: {
    ...
    bulkDeleteError:
      'При удалении записей произошла ошибка. Чтобы просмотреть дополнительную информацию, откройте консоль.',
    errorFetchingRecords:
      'Произошла ошибка при получении записей. Чтобы просмотреть дополнительную информацию, откройте консоль.',
    errorFetchingRecord:
      'Произошла ошибка при получении записи. Проверьте консоль, чтобы увидеть больше информации.',
    ...
    error404Resource: 'Ресурс с указанным идентификатором: {{resourceId}} не найден',
  },
  labels: {
    loginWelcome: '',
  },
  buttons: {
    ...
    filter: 'Фильтр',
    create: 'Добавить',
    createFirstRecord: 'Создать новую запись',
  },
  actions: {
    new: 'Создать новый',
    edit: 'Редактировать',
